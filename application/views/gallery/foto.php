                            ...
                            <div>
                                <?php if($ReadDS->UserID == $this->session->userdata('UserID')): ?>
                                    <button type="button" class="btn btn-info" data-toggle="modal"
                                        data-target="#exampleModal_<?php echo $ReadDS->FotoID; ?>"><i class="fa-solid fa-pen-to-square"></i>
                                    </button>
                                    <a href="<?= site_url('Welcome/deleteDataFoto/' . $ReadDS->FotoID) ?>" class="btn btn-danger" onclick="return confirmDelete()"><i class="fa-solid fa-trash"></i></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
